...
Entre esses métodos, um dos mais promissores é o método de Galerkin sem elementos (**EFG**, *Element-Free Galerkin*) [2], devido às boas taxas de convergência, à facilidade de criação da discretização e de representação do domínio, além da independência completa da integração na forma fraca.
